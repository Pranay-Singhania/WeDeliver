    ...
    <div className="w-10/12 lg:w-6/12 my-16 m-auto">
      ...
      <div className="flex border border-gray-400 p-3 rounded-sm mb-8">
        <input
          ...
          className="outline-none font-semibold tracking-wide text-gray-800 text-sm w-full "></input>
        <button>
        ...
        <div className="flex flex-wrap cursor-pointer">
          {popularCuisines &&
            popularCuisines.map((el) => {
              return (
                <div key={el.id}>
                  <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,c_fill/" + el.imageId} alt="cuisines" width={85} />
                </div>
              );
            })}
        </div>
